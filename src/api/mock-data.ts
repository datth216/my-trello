export const mockData = {
  board: {
    ...
    ownerIds: [],
    memberIds: [],
    columnOrderIds: ['column-id-03', 'column-id-02', 'column-id-01'],
    columns: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
        ...
        cards: [
          {
            ...
            cover:
              'https://images.unsplash.com/photo-1696958363946-b58f40cda426?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2128&q=80',
